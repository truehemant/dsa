# Q21: Write a program in python to delete the node at the end of a Circular Linked List.
...
class CircularLinkedList:
    ...
    def remove_last(self):
        ...
        temp.next = self.head 
        print(f'The deleted node is: {deleted}')


cll = CircularLinkedList()
print('Circular Linked List: delete the node at the end of a Circular Linked List.')
print('-------------------------------------------')
...
cll.remove_last()
print('After Deletion the new list are: ')
cll.display()

'''
OUTPUT

Circular Linked List: delete the node at the end of a Circular Linked List.
-------------------------------------------
