'''
Q12: Write a program in python to insert a new node at the end of a Simply linked list.

The test data and expected output :

input the number of nodse: 3
...
input data to insert at the end: 8
...
print('Linked List: insert a new node at the end of a Singly linked list: ')
print('-------------------------------------------')
